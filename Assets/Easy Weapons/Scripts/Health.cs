...
public class Health : MonoBehaviour
{
    ...
    public AudioClip[] DeadSounds;             //The sounds to play randomly when dead
    ...
    {
        if(collision.gameObject.name != "Terrain")//exclude contact with the ground
            ChangeHealth(-10);
    }
	...
	public void Die()
	{
        ...
        if (DeadSounds.Length > 0)
            GetComponent<AudioSource>().PlayOneShot(DeadSounds[Random.Range(0, DeadSounds.Length - 1)]);
